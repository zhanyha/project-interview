...
public class C2CombinationSum {
    ...
    private void combinationSumCore(int[] candidates, int index, int target, List<Integer> list) {
        if(target == 0){
        ...
        combinationSumCore(candidates,index + 1, target, list);
